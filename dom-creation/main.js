...
function renderPokemon(pokemon) {
  ...
  divCol.appendChild(pokeCard);

  var pokeImg = document.createElement('img');
  pokeImg.src = pokemon.imageUrl;
  pokeCard.appendChild(pokeImg);

  var pokeCardTxt = document.createElement('div');
  pokeCardTxt.className = 'pokemon-card-text';
  pokeCard.appendChild(pokeCardTxt);
  ...
  pokeDesc.innerHTML = pokemon.description;
  pokeCardTxt.appendChild(pokeDesc);
